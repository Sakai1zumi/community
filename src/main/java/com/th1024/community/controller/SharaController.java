...
/**
 * @author izumisakai
 * @create 2022-09-03 15:13
 */
@Controller
public class SharaController implements CommunityConstant {

    private static final Logger LOGGER = LoggerFactory.getLogger(SharaController.class);
